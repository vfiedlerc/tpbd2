      ...
      <div className="row">
        <div className="col-md-4 mt-3">
          <div className="transactions-count">
            ...
            <hr />
            <h5>Renda : {totalIncomeTransactions.length}</h5>
            <h5>Despesa : {totalExpenceTransactions.length}</h5>
        ...
        <div className="col-md-4 mt-3">
          <div className="transactions-count">
            <h4>Faturamento total : {totalTurnover}</h4>
            <hr />
            <h5>Renda : {totalIncomeTurnover}</h5>
            <h5>Despesa : {totalExpenceTurnover}</h5>
